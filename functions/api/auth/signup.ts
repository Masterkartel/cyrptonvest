...
export const onRequestPost: PagesFunction<Env> = async ({ request, env }) => {
  try {
    ...
    try {
      ...
      console.warn("wallet preference save failed", {
        userId: id,
        email,
        currency,
    ...
    try {
      ...
      const bodyText =
        typeof t.welcomeBody === "function"
          ? t.welcomeBody(safeName)
          : `Hi ${safeName}, your account is ready.`;
      const buttonText = t.welcomeButton || "Go to Dashboard";
        ...
        <td align="center" style="padding:24px">
          <table
            ...
            style="max-width:600px;background:
              ...
              linear-gradient(180deg,#101934,#0c1226);
          ...
          >
                ...
                <table width="100%">
                  <tr>
                    <td style="font-weight:800;font-size:16px;color:#e6edf3">
                      <img
                        src="${origin}/assets/logo-email.png"
                        width="22"
                        height="22"
                        alt="Cyrptonvest"
            ...
            <tr>
              <td style="padding:22px">
                ...
                <a
                  href="${dash}"
                  style="display:inline-block;background:linear-gradient(180deg,#fbbf24,#f59e0b);color:#111827;font-weight:800;padding:12px 16px;border-radius:999px"
                >
